<?php 
// 
//  CO.class.user.schedule.php
//  This class defines an object that respresents an attorney's Colorado court schedule.  
//  
//
//  My standard date format "Y-m-d H:i:s"
//
//  Created by Scott Brenner on Monday, September 17, 2012 1:53:31 PM.
...
class barNumberSchedule
{
    ...
    // Method Definitions
    function __construct($userBarNumber, $verbose)
    {
